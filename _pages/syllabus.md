  ...
  banner: |
    ...
    <div style="width: 100%; display: table-row;">
        <div style="display: table-cell; padding:5px; width:33%;">
            <a title="BernardoSulzbach, CC BY-SA 4.0 &lt;https://creativecommons.org/licenses/by-sa/4.0&gt;, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:DVD_Rental_Query.png"><img style="width:100%; height:auto;" alt="A picture showing an SQL select statement against a database" src="https://commons.wikimedia.org/w/index.php?title=Special:Redirect/file/DVD_Rental_Query.png"></a>
        </div>
        <div style="display: table-cell; padding:5px; width:33%;">
            <a title="Timo Tijhof, CC BY 4.0 &lt;https://creativecommons.org/licenses/by/4.0&gt;, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:MediaWiki_1.28.0_database_schema.svg"><img style="width:100%; height:auto;" alt="MediaWiki 1.28.0 database schema" src="https://commons.wikimedia.org/w/index.php?title=Special:Redirect/file/MediaWiki_1.28.0_database_schema.svg"></a>  
        </div>
        <div style="display: table-cell; padding:5px; width:33%;">
            <img src="images/DatabaseSchema.png" alt="Example Record-Based Database Schema" style="width:256px; max-width:100%; height:auto; display:block; margin:0 auto;">
        </div>
    </div>
    </div>
...
schedule:
  ...
  - week: "8"
    date: "1"
    title: "Facilitating Integrity with SQL Triggers"
    link: "Activities/Triggers"
    readings:
      - rtitle: "SQL Views Slides"
        rlink: "./files/cosc_304/topics/16_views/304_16_Views.pdf"
      - rtitle: "SQLite CREATE TRIGGER Documentation"
        rlink: "https://www.sqlite.org/lang_createtrigger.html"
  - week: "9"
    date: "0"
